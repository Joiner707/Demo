...
@Configuration
public class PreRedisConfig {

    @Bean("preRedis")
    public RedisTemplate<String, Object> getRedisTemplate(
            @Value("${spring.redis.pre.host}") String hostName,
            @Value("${spring.redis.pre.password}") String password,
            @Value("${spring.redis.pre.port}") int port,
